...
export function Task4Compo5({ToyData,ToyLikeFun,ToyCartFun}){
          // console.log(ToyData);
    return( 
        <>
          <div className="Task4Compo5">
            <div className="Task4Compo5_heading">CART</div>
              {
                ToyData.length>0
                ?
                ...
                :
                  <div className="Task4Compo5_cart_items_no">No Items In Cart</div>
              }
          </div>  
        </>
    )
